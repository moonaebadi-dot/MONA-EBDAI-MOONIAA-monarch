...
function LanguageProvider({ children }) {
	const [lang, setLangState] = (0, import_react.useState)("fa");
	(0, import_react.useEffect)(() => {
...
var Route$1 = createRootRoute({
	head: () => ({
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;1,9..144,500;1,9..144,600&family=Vazirmatn:wght@400;500;600;700&display=swap"
			},
			{
				rel: "stylesheet",
				href: styles_default
...
//#endregion
export { useLang as n, router_exports as t };
